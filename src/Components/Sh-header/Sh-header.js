...
import './Sh-header.css';

export const ShHeader = () => {
	return (
		<div className="d-flex justify-content-between w-100 header-all-wrap">
			<p className="m-0 fw-bold fs-4">Overview</p>
			<div className="d-flex">
				<div className="header-svg-wrap d-flex align-items-center">
					<svg
						width="16"
						height="16"
						viewBox="0 0 16 16"
				...
				<div className="d-flex header-user-wrap align-items-center">
					<p className="m-0">Jones Ferdinand</p>
					<img
						width={40}
						height={40}
						src={ManImage}
